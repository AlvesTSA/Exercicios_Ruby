...
puts"Comparativo de Consumo de Combustível\n"
...
for i in 0..4
    ...
    valor = preco * litros
    puts"#{i + 1}  -  #{nome[i]}   - #{consumo[i].round(1)}   -   #{litros.round(1)}    litros - R$ #{valor.round(2)}"
end

print"O menor consumo e do #{nome[y]}"