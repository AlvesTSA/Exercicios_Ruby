...
puts"Projeçao de Gastos com Abono\n============================"

for i in 0..99
    
    print"Salario: "
    salari = gets.chomp.to_f
    salario.push(salari)
...
for i in 0..count1 - 1
    ...
    puts"R$ #{salario[i]} -  R$ #{abono[i]}"
end

puts"Foram processados #{count1} colaboradores"
puts"Total gasto com abonos: R$ #{total}"
puts"Valor mínimo pago a #{count2} colaboradores"
puts"Maior valor de abono pago: R$ #{ maior_abono}"